...
class GameSession(Base):
    ...
    game_state = relationship("GameState", back_populates="session", uselist=False)
...
class Question(Base):
    ...
    game_sessions = relationship("GameSession", back_populates="current_question")
...
class Admin(Base):
    ...
    session_id = Column(BigInteger, ForeignKey('game_sessions.id'), nullable=False)
