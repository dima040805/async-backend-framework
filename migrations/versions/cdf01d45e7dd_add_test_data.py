...
revision = 'cdf01d45e7dd'
down_revision = '724d44de98dd'  # МЕНЯЕМ НА ПОСЛЕДНЮЮ МИГРАЦИЮ
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.bulk_insert(answer_variants_table, [
        # Вопрос 1
        ...
        {'question_id': 2, 'text': 'Документы', 'points': 15, 'position': 4},
        {'question_id': 2, 'text': 'Очки', 'points': 5, 'position': 5},
        
        # Вопрос 3
        {'question_id': 3, 'text': 'Полотенце', 'points': 30, 'position': 1},
        {'question_id': 3, 'text': 'Крем от загара', 'points': 25, 'position': 2},
        {'question_id': 3, 'text': 'Купальник', 'points': 20, 'position': 3},
