...
def upgrade() -> None:
    ...
    op.add_column('player_answers', sa.Column('created_at', sa.DateTime(), nullable=True))
    op.add_column('session_players', sa.Column('joined_at', sa.DateTime(), nullable=True))
